...
//Sean Rice, Matthew Arcarese, Davron
//
//
...
module RegisterFile(ReadRegister1, ReadRegister2, WriteRegister, WriteData, RegWrite, Clk, ReadData1, ReadData2);
    input [4:0] ReadRegister1;  // values range 0x00 - 0x1f (decimal 0 - 31)
    input [4:0] ReadRegister2;  // values range 0x00 - 0x1f (decimal 0 - 31)
    input [4:0] WriteRegister;  // values range 0x00 - 0x1f (decimal 0 - 31)
	...
	begin
	   ...
	   // register 0, write the data to register
